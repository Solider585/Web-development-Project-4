 ...
 * of the body.
 */
// $("h1").css("background-color", "red").css("text-align", "center");
$("h1").addClass("background");
...
$("button").one("click", function () {
    ...
    var squares = [],
        ...
        startNewGame = function () {
            alert("Player one, you may start the game by clicking any square to place X followed by player two with O");
            turn = "X";
            score = {"X": 0, "O": 0};
            moves = 0;
        ...
        set = function () {
            ...
            if (win(score[turn])) {
                alert("Player" + turn + " wins this game!");
                alert("Clearing the board for a new game.");
                startNewGame();
         ...
         */
        play = function () {
            var board = $("<table class='center' border=2 cellspacing=1>"), indicator = 1;
